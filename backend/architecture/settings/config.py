...
# ──────────────────────── Configuration LLM ────────────────────────
LLM_API_KEY = os.getenv("LLM_API_KEY", "sk-e94c1284c96146beb589473f40488764")
...
ACP_SERVER_PORT = int(os.getenv("ACP_SERVER_PORT", "8001"))
...
EXECUTOR_STEP_TIMEOUT = int(os.getenv("EXECUTOR_STEP_TIMEOUT", "300"))  # secondes
...
DEFAULT_AGENTS = ["executor", "planner"]
