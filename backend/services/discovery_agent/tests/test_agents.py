...
from DiscoveryAgent.agents import DiscoveryAgent

class TestImports(unittest.TestCase):
    def test_import_DiscoveryAgent(self):
        @tool
    ...
    def test_import_tools(self):
        from DiscoveryAgent.tools import generation, prediction, retrieval
        self.assertIsNotNone(generation)
        self.assertIsNotNone(prediction)
        self.assertIsNotNone(retrieval)

    def test_import_analysis(self):
        from DiscoveryAgent.analysis import analysis_helper, drug_likeness_analyzer
