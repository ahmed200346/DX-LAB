...
import OrchestratorView from "@/components/Dashboard/OrchestratorView";
        ...
        <div className="container relative z-10">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 text-center">
              ...
              >
                Lab <span className="text-primary italic">Orchestrator</span>
              </h1>
              <p
                className="mx-auto mb-6 max-w-[720px] text-lg font-medium text-body-color dark:text-body-color-dark"
                style={{ fontFamily: "'Sora', sans-serif" }}
              >
                Combined Planner & Executor layer managing multi-agent workflows
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 mx-auto">
              <div className="shadow-sm dark:bg-[#0a0a0f] rounded-xl bg-white border border-gray-200 dark:border-white/10 p-6 sm:p-10 transition-all">
                <ErrorBoundary><OrchestratorView /></ErrorBoundary>
              </div>
            </div>
          </div>
        </div>
